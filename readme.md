...
- `illustrations/` — `mascot/` (Sparky), `benefits/`, `scenes/`, `marketing/`, `digital-assets/` (app + Walmart+ product shots), `pins-patches/` (culture patches, buttons, merch marks, and enamel pins — consolidated from three old folders; `associates-week-2025.svg` is the 2025 campaign badge, `we-heart-our-people.svg` the Associates Week hearts patch)

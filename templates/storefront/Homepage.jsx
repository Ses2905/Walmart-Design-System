    ...
    <div style={{ maxWidth: 1392, margin: '0 auto', padding: '24px', fontFamily: 'var(--font-sans)' }}>
      ...
      <div style={{ display: 'grid', gridTemplateColumns: '2fr 1fr', gap: 16, marginBottom: 24 }}>
        <div style={{ background: 'var(--wm-sky-blue)', borderRadius: 'var(--radius-xl)', padding: '44px 48px', display: 'flex', flexDirection: 'column', justifyContent: 'center', minHeight: 300, position: 'relative', overflow: 'hidden' }}>
          ...
          <p style={{ fontSize: 18, color: 'var(--wm-bentonville-blue)', maxWidth: '32ch', marginBottom: 24, textWrap: 'balance' }}>Pickup, delivery, and shipping — all in one place. Save more with Walmart+.</p>
        ...
        <div className="wm-surface-dark" style={{ borderRadius: 'var(--radius-xl)', padding: 32, display: 'flex', flexDirection: 'column', justifyContent: 'center' }}>
          ...
          <h2 style={{ fontSize: 28, fontWeight: 'var(--fw-bold)', lineHeight: 1.1, marginBottom: 12, color: '#fff', maxWidth: '16ch' }}>Free delivery, free shipping</h2>
